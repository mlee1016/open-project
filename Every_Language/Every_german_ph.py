...
class Korean():
    ...
    def return_ie():
        return Korean.se_
korean_present_polite = Korean("German useful phrases: ",copy.deepcopy(default_Ko_Ph[0]))
...
korean_past_polite = Korean("German useful phrases 2: ",copy.deepcopy(default_Ko_Ph[1]))
...
korean_future_polite = Korean("German accusative cases 2: ",copy.deepcopy(default_Ko_Ph[2]))
...
korean_past_polite2 = Korean("German accusative cases: ",copy.deepcopy(default_Ko_Ph[3]))
...
korean_future_polite2 = Korean("German nominative cases: ",copy.deepcopy(default_Ko_Ph[4]))
...
german_useful_polite = Korean("German asking questions: ",copy.deepcopy(default_Ko_Ph[5]))
...
for s in range(len(german_useful_polite.de_ko_List)):
    col_o6.append(german_useful_polite.de_ko_List[s][0])
...
korean_particle_polite = Korean("German asking questions 2: ",copy.deepcopy(default_Ko_Ph[6]))
...
All_German_lists = [german_useful_polite,korean_particle_polite,korean_past_polite2,korean_present_polite,
...
All_Audio_korean = [None]*len(All_German_lists)
