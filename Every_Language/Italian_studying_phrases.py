...
from All_Italian_phrases import *
...
#options:str = st.selectbox("Pick a list to study:",("",
  ...
  #"4.1 {korean_present_polite.getDefault_Name()}","4.6 korean present polite words",
  ...
  #f"7.1 {korean_past_polite.getDefault_Name()}","7.2 korean past polite words",),index=None,placeholder="Select List")

studying_list = Italian_useful.de_it_List
#if options != None and (int(options[2])%2 != 0): 
...
s.audio(Italian_audio[st.session_state["num"]],format="audio/mp3",autoplay=True)
