...
with open(r'C:\Users\Owner\OneDrive\Desktop\css-HTML\open-project\Every_Language\korean_present_polite.csv', encoding="utf-8") as f:
    reader = csv.reader(f)
    default_Ko_Ph[0] = list(reader)
with open(r'C:\Users\Owner\OneDrive\Desktop\css-HTML\open-project\Every_Language\korean_past_polite.csv', encoding="utf-8") as f:
    reader = csv.reader(f)
    default_Ko_Ph[1] = list(reader)


with open(r'C:\Users\Owner\OneDrive\Desktop\css-HTML\open-project\Every_Language\korean_future_polite.csv', encoding="utf-8") as f:
    reader = csv.reader(f)
    default_Ko_Ph[2] = list(reader)

with open(r'C:\Users\Owner\OneDrive\Desktop\css-HTML\open-project\Every_Language\korean_past_polite2.csv', encoding="utf-8") as f:
    reader = csv.reader(f)
