...
russian_genitive_polite = Russian("Russian genitive case: ",copy.deepcopy(default_Ru_Ph[6]))
#print(len(korean_particle_polite.de_ko_List))


russian_genitive_polite_words = set()
str_kp7 = []
col_o7 = []
...
for t in range(len(russian_genitive_polite.de_ru_List)):
    col_o7.append(russian_genitive_polite.de_ru_List[t][0])


for i in range(len(col_o7)):
  str_kp7.extend(col_o7[i].split())
for d in range(len(str_kp7)):
    russian_genitive_polite_words.add(str_kp7[d])
#print(len(str_kp7))
...
russian_Instrumental_polite,russian_prepositional_polite,Russian_dative_polite,russian_genitive_polite]

All_words_russian = [r_a_polite2_words,r_n_polite_words,
russian_present_polite_words,russian_p_polite_words,russian_I_polite_words,russian_genitive_polite_words]
